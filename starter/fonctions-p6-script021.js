...
const whatDoYouDo = function(job, firstName) {
    ...
    if(job === "teacher") return `${firstName} teaches kids how to code.`;
    else if(job === "driver") return `${firstName} drives a cab in Lisbon.`;
    else if(job === "designer") return `${firstName} designs beautiful websites.`;
    else return `${firstName} does something else.`;
}
